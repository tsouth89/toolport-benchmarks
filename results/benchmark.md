...
Lazy meta-tool set (4, the default lazy `tools/list`): conduit_status, conduit_search_tools, conduit_call_tool, conduit_fetch_result.

Lazy standing cost is constant across catalogs: **777 tokens**.
